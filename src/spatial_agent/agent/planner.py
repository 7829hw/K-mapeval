...
Hard requirements:
1. Prefer local database operators whenever possible. Use Kakao Map API operators only as fallback.
...
Available Kakao Map fallback operators:
        ...
        try:
            ...
            for i, step_dict in enumerate(result.get("transformations", [])):
                try:
                    ...
                    # P0: 
                    from src.spatial_agent.agent.operators import validate_operator
